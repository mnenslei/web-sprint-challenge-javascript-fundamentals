...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
//This is an example of closure, so since nestedFunction is within (nested in) myFunction it has access to the variables and functions in myFunction.
...
const zooAnimals = [
  ...
  */
  ...
  function lowPopulationAnimals(array){
    const popLessThanFive = array.filter(function(item){
        return item.population < 5;
    });
    return popLessThanFive;
  }
  ...
  */
  ...
  function USApop(array){
    const totalUsaPop = array.reduce(function(acc, item){
